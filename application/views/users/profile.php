...
<div class="content">
    <div class="profile" style="padding: 20px 0; border: solid 1px; border-radius: 10px;">
        <?php if (Session::existed('admin_id')) { ?>
            <p class="signup-already">
                <span>Bạn là admin, hãy sử dụng một số chức năng bạn cần</span>
            </p>
            <div style="border: solid 1px; border-radius: 1px; background-color:#f9f9f9; ">
