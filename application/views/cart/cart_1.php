    ...
    if($cart){ ?>
                    ...
                    $qty = 0;
                        ...
                        foreach ($cart as $cart) {?>
                            <tr>
                                ...
                                <td>
                                    <form class='d-inline' action="<?php echo URL ?>/cart/updateQty/<?php echo $cart->product ?> " method="POST">
                                    ...
                                    <form class='d-inline' action="<?php echo URL ?>/cart/delete/<?php echo $cart->cart_id ?>" method='GET'>
                                        <input type="hidden" name="csrf" value="<?php new Csrf(); echo Csrf::get()?>">
        ...
        <ul class="list-group my-3 ">
            ...
            <li class="list-group-item">
                <form class='d-inline' action="<?php echo URL ?>/cart/clear" method='GET'>
                    <input type="hidden" name="csrf" value="<?php new Csrf(); echo Csrf::get()?>">
